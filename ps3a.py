...
def update_hand(hand, word):
    ...
    """
    # TO DO...
    modify_hand = hand.copy()
    for i in word:
        modify_hand[i] = modify_hand[i]-1
    return modify_hand
...
def is_valid_word(word, hand, word_list):
    ...
    if word not in word_list:
        return False
    for i in word:
        if i not in hand_new or hand_new[i]==0:
            return False
        else:
            hand_new[i] -= 1
    return True
    ...
    for i in word_list:
        ...
        if word == '.':
            ...
            if is_valid_word == False:
                ...
                totalscore += get_word_score
                print('"word" earned "get_word_score" points. Total: "totalscore" points')
                update_hand
...
def play_game(word_list):
    ...
    # TO DO...
    while True:
        a=input('Enter n to play new hand, r to play the last hand, or e to exit game: ')
        if a == 'n':
